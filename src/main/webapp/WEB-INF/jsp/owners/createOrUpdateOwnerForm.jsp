...
<petclinic:layout pageName="owners">
    <h2>
        <c:if test="${owner['new']}">Nuevo </c:if> propietario/a
    </h2>
            ...
            <div class="col-sm-offset-2 col-sm-10">
                <c:choose>
                    <c:when test="${owner['new']}">
                        <button class="btn btn-default" type="submit">Añadir propietario/a</button>
                    </c:when>
                    <c:otherwise>
                        <button class="btn btn-default" type="submit">Actualizar propietario/a</button>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
